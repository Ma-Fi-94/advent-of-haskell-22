...
-- Positive modulus of a potentially negative number
(%%) :: Int -> Int -> Int
a %% b
    | a >= 0 = a `rem` b
    | a < 0  = (a `rem` b) + b
...
-- A simple integer range in arbitrary direction
